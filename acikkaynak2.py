...
// app adında bşr flask sınıfı oluşturmaya yarar.
app = Flask(__name__)

@app.route('/')
def index():

 #URL bilgisine göre API renk listesini url değişkenine atar  
...
# Okunabilirliği daha fazla arttırmak için 5 boşlukluk girinti yapar ve metin gibi gösterilmesini sağlar.
